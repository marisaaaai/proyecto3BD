...
const Mods = ({ onClick }) => {
  return (
    <div className="mods-wrapper">
      ...
      <Link
        to="/comunNSA-home/mod/inact-song"
        className="options"
        onClick={onClick}
      >
      ...
      <Link to="/comunNSA-home/mod/modss" className="options" onClick={onClick}>
        <div className="mod-wrapper">
          <h4>
      ...
      <Link to="/comunNSA-home" className="options" onClick={onClick}>
        <div className="mod-wrapper">
          <h4>Regresar</h4>
        </div>
      </Link>
